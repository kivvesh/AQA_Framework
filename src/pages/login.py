...
class Login(BasePage):
    ...
    def login(self, user, password):
        ...
        self.click_after_detect_element(
            (By.XPATH, '//input[@name="user-name"]'), test_name, 5
        ).send_keys(user)
        self.click_after_detect_element(
            (By.XPATH, '//input[@name="password"]'), test_name, 5
        ).send_keys(password)
        self.click_after_detect_element(
            (By.XPATH, '//input[@name="login-button"]'), test_name, 5
        )
    ...
    def logout(self):
        ...
        self.click_after_detect_element(
            (By.XPATH, '//button[contains(text(),"Menu")]'), test_name, 5
        )
        self.click_after_detect_element(
            (By.XPATH, '//a[contains(text(),"Logout")]'), test_name, 5
        )
